...
namespace Church.WebApp.Controllers {
    ...
    public class DownloadInterlinearTranslationDocxController : Controller {
        private readonly IConfiguration Configuration;
        public DownloadInterlinearTranslationDocxController(IConfiguration configuration) {
        ...
        private async Task<Stream> CreateDocx(string queryString) {
            ...
            if (paramsTable.Length == 2) {
                ...
                var result = new InterlinearExporter(licData).ExportBookTranslation(book, ExportSaveFormat.Docx);
